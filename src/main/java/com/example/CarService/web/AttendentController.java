 ...
 * 2. Also, it accepts attendentId of type String and object of type ModelMap as
 * argument.
...
public class AttendentController {
    ...
    public String getAttendent(@PathVariable String attendentId, ModelMap model) {
        ...
        model.addAttribute("attendantName", "John Smith");
        model.addAttribute("attendantSpeciality", "Car Engine Repair");
        return "attendent";
    }
